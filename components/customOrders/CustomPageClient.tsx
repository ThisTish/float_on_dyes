			...
			<Card className="p-5">
				<CardHeader>
					...
					<CardDescription className="-mt-2 text-pretty px-0">
						Please select from the options below or
						<Link
							href="/contact"
							className="font-bold text-darkGreen hover:text-darkBlue"
						>
							{" "}
							contact us
						</Link>{" "}
						for more options or complex requests.
					</CardDescription>
				</CardHeader>
				...
				<CardContent className="mb-5">
					<CustomOrderForm
						discs={discs}
						handleDyeChange={handleDyeChange}
					/>
				</CardContent>
			</Card>
