...
// todo test avatar and disabled with google or discord sign in
...
const UserProfileForm = () => {
	...
	return (
		<Form {...form}>
			{disabled ? (
				<div className="text-destructive text-sm text-balance">Since you signed in with Google or Discord, options to update your profile are limited.</div>
			): null}
			<form
